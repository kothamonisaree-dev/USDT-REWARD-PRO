          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-800">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3.5 py-2.5 bg-slate-800/80 hover:bg-slate-700 text-slate-200 border border-slate-700 text-xs font-bold flex items-center gap-2 rounded-xl shrink-0 transition-colors"
                title="Refresh user list from database"
              >
                <RefreshCw className={`w-3.5 h-3.5 text-[#F4C542] ${isRefreshing ? 'animate-spin' : ''}`} />
